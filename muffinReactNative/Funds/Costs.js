...
export default function Costs() {
    ...
    const getData = () => {
        setIsLoading(true)
        let URL = 'http://192.168.231.132:8000/costs'
        fetch(URL, {
            headers: {
                'Token': token
            }
    ...
    function deleteData(id) {
        ...
        fetch('http://192.168.231.132:8000/costs/'+id, requestOptions).then((res) => {
            return res.json();
        }).then((res) => {
            getData()
    ...
    function sendData() {
        ...
        if (currentAmount !== '') {
            fetch('http://192.168.231.132:8000/costs', requestOptions).then((res) => {
                res.json()
                // console.log(res)
                return res;
            }).then((res) => {
